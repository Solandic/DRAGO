...
export var platformControllerWrapper = function (optionalDeps, controllerDescriptor, controllerConfig, viewerScriptFlowAPI, viewerScriptFlowAPIInitPromise, getAppData) { return __awaiter(void 0, void 0, void 0, function () {
    var appData, panoramaClient, _a, locationAPI, windowAPI, siteAPI, seoAPI, flowAPI;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, controllerDescriptor.method({
                        controllerConfig: controllerConfig,
                        flowAPI: flowAPI,
                        appData: appData,
