...
import { aModalUrl } from './modalUrlBuilder';
var maxHeight = 660;
var ModalManager = /** @class */ (function () {
    ...
    ModalManager.prototype.openModal = function (_a) {
        var modalName = _a.modalName, width = _a.width, _b = _a.modalData, modalData = _b === void 0 ? null : _b, _c = _a.useBareTheme, useBareTheme = _c === void 0 ? true : _c;
    ...
    ModalManager.prototype.openSetPaymentMethod = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.openModal({ modalName: 'setPaymentMethod', width: 600 })];
            });
        });
    };
    ...
    ModalManager.prototype.openSetShippingMethod = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.openModal({ modalName: 'setShippingMethod', width: 600 })];
            });
        });
    };
    ...
    ModalManager.prototype.openNotInLiveSite = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.openModal({ modalName: 'notInLiveSite', width: 600 })];
            });
        });
    };
    ...
    ModalManager.prototype.openSubscriptions = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.openModal({ modalName: 'subscriptions', width: 375 })];
            });
        });
    };
    ...
    ModalManager.prototype.openCantShipToDestination = function (modalData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                data = _.omitBy(modalData, _.isNil);
                return [2 /*return*/, this.openModal({ modalName: 'deliveryError', width: 460, modalData: { deliveryError: data } })];
            });
        });
    };
    ModalManager.prototype.openPaypalError = function (modalData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.openModal({ modalName: 'paypalError', width: 460, modalData: { paypalError: modalData } })];
            });
        });
    };
    ModalManager.prototype.openErrorWithPaymentMethod = function (modalData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.openModal({ modalName: 'paymentError', width: 536, modalData: { paymentError: modalData } })];
            });
        });
    };
    ModalManager.prototype.openStartFastFlowError = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.openModal({ modalName: 'startFastFlowError', width: 460 })];
            });
        });
    };
    return ModalManager;
