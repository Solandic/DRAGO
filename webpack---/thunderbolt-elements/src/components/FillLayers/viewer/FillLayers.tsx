...
import type { FillLayersProps } from '../FillLayers.types';
...
const FillLayers: React.FC<FillLayersProps> = props => {
  ...
  const Media =
    (useWixMediaCanvas && canvasRef) || hasCanvasAnimation ? (
      <wix-media-canvas data-container-id={containerId}>
        {ImageComponent}
  ...
  return (
    <div
      ...
      data-motion-part={`BG_LAYER ${containerId}`}
