...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["iframeAppBiContext"] = factory();
...
/******/ 	__webpack_require__.p = "https://static.parastorage.com/services/iframe-app-bi-context/1.578.0/";
/******/
/******/
...
/* harmony import */ var _consts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./consts */ 0);
...
Object.defineProperty(exports, "__esModule", { value: true });
var cookie_storage_1 = __webpack_require__(/*! ./storage/cookie-storage */ 5);
var config_storage_1 = __webpack_require__(/*! ./storage/config-storage */ 8);
...
var SlaveBsiManager = /** @class */ (function () {
    ...
    SlaveBsiManager.prototype.extend = function () {
        ...
        if (ttl) {
            ...
            this.timeout = setTimeout(function () { return _this.extend(); }, ttl - 1000);
        }
    };
    SlaveBsiManager.prototype.getAndNotify = function () {
        // Notify listeners
        this.acitivityListeners.forEach(function (listener) { return listener(); });
    ...
    SlaveBsiManager.prototype.init = function (api, options) {
        ...
        this.config = new config_storage_1.ConfigStorage(this.api.getConsentPolicy, this.api.getCommonConfig).subscribe(function () { return _this.extend(); });
...
var isWixCom = function () {
    return config_1.WIX_DOMAINS.some(function (domain) { return window.document.location.hostname.indexOf(domain) !== -1; });
};
var getCookieDomain = function () {
    if (!cookieDomain) {
        var hostname = window.document.location.hostname;
        cookieDomain = isWixCom() ? hostname.replace(/^www\./, '') : hostname;
    }
    return cookieDomain;
};
var CookieStorage = /** @class */ (function () {
    function CookieStorage(configStorage, getCookieReaderWriter) {
        if (getCookieReaderWriter === void 0) { getCookieReaderWriter = function () { return ({
...
})(ConsentPolicyCategories = exports.ConsentPolicyCategories || (exports.ConsentPolicyCategories = {}));
...
var src_ConsentPolicyAccessor = /** @class */ (function () {
    function ConsentPolicyAccessor(env) {
        ...
        this.consentPolicyAccess = Object(consent_policy_accessor["a" /* getConsentPolicyManager */])(this.env);
    }
...
var createBsiManager = function (Wix) {
    ...
    return new manager_slave["SlaveBsiManager"]()
        .init({
        getCommonConfig: function () { return ({
            get: function (key) { return callSafe('get', key); },
            subscribe: function (handler) { return callSafe('onCommonConfigChanged', handler); }
        }); },
        getConsentPolicy: function () { return ({ policy: policyAccessor.getCurrentConsentPolicy() }); }
    }, { enableCookie: true });
};
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getBsi", function() { return getBsi; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getBiContext", function() { return getBiContext; });
...
var ENRICHERS = {
    _msid: function (Wix) { return index_callSafe(Wix, 'getInstanceValue', 'metaSiteId'); },
    _appId: function (Wix) { return index_callSafe(Wix, 'getInstanceValue', 'appDefId'); },
    _instanceId: function (Wix) { return index_callSafe(Wix, 'getInstanceId'); },
    _siteOwnerId: function (Wix) { return index_callSafe(Wix, 'getSiteOwnerId'); },
    _siteMemberId: function (Wix) { return index_callSafe(Wix, 'getUid') || ''; },
    _visitorId: function (Wix) { return index_callSafe(Wix, 'getInstanceValue', 'aid'); },
    _viewMode: function (Wix) { return index_callSafe(Wix, 'getViewMode'); },
    _uuid: {
        enabled: function (Wix) { return index_callSafe(Wix, 'getViewMode') === 'editor'; },
        value: function (Wix) { return index_callSafe(Wix, 'getUid') || ''; },
    },
    _bsi: function (Wix) { return getBsi(Wix); },
};
var getBsi = function (Wix) { return bsiManager && bsiManager.getBsi(Wix); };
...
angular.module('wix.common.bi')
  .constant('recursiveExtend', (function () {
...
angular.module('wix.common.bi')
  .directive('wixBi', function (domBiLogger, $window) {
    ...
    return {
      ...
      link: { //actually, in angular ~1.2, post link functions are run in reverse order,
...
(function () {
  ...
  angular.module('wix.common.bi')
    .provider('biBrowsingSession', function () {
      ...
      this.$get = function ($window, Logger) {
        ...
        function track() {
          ...
          listen(function (fromUrl, toUrl) {
            ...
            logger.log({from: fromUrl, to: toUrl, fis: firstInSession, sr: screen.sr, wr: screen.wr});
            firstInSession = 0;
          });
        }
...
angular.module('wix.common.bi')
  ...
  .provider('wixBiLogger', function (biLoggerProvider, domBiLoggerProvider, biBrowsingSessionProvider) {
    ...
    /* @ngInject */
    this.$get = function (biLogger, domBiLogger, $q, $rootScope, $window, $parse, nowWrapper) {
