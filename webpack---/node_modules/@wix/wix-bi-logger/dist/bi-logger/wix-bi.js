...
W.BI.Logger = (function () {
  var globalApi  = (function () {
    ...
    function getGlobal(cb, defaultValue) {
      ...
      if (typeof self !== 'undefined' && self) { // jshint ignore:line
    ...
    function getConsentPolicyDetails() {
      return getGlobal(function (g) {
        ...
        return context && typeof context.getCurrentConsentPolicy === 'function' && context.getCurrentConsentPolicy();
      });
    }
    ...
    function getConsentPolicy(consentPolicyDetails) {
      consentPolicyDetails = consentPolicyDetails || getConsentPolicyDetails();

      return (consentPolicyDetails && consentPolicyDetails.policy) || DefaultConsentPolicy;
    }
    ...
    function getBsi() {
      return getGlobal(function (g) {
        if (g.Wix && g.__bsiManager && typeof g.__bsiManager.getBsi === 'function') {
  ...
  function biLogger(args) {
    ...
    function _log(eventArgs, callback) {
      ...
      }, defaultEventArgs, _options.defaultEventArgs, eventArgs);
      ...
      var validatorsResult = schemaValidators.length > 0 ?
    ...
    function _error(errorArgs, callback) {
      ...
      var _errorFieldsRestrictions = {
        ...
        cat: { type: 'number', values: [W.BI.Categories.EDITOR, W.BI.Categories.VIEWER, W.BI.Categories.TIMEOUTS, W.BI.Categories.SERVER] },
        iss: { type: 'number' },
        sev: { type: 'number', values: [W.BI.ErrorSeverity.RECOVERABLE, W.BI.ErrorSeverity.WARNING, W.BI.ErrorSeverity.ERROR, W.BI.ErrorSeverity.FATAL] },
        errc: { type: 'number' },
        httpc: { type: 'number' },
      ...
      var errorParams = _extend({}, defaultErrorArgs, _options.defaultErrorArgs, errorArgs, { evid: EVENT_IDS.ERROR });
    ...
    function _reportOnReady(viewName, eventArgs, callback) {
      ...
      var eventParams = _extend({}, eventArgs, { evid: EVENT_IDS.ON_READY, view: viewName });
    ...
    function _reportRouteChange(viewName, eventArgs, callback) {
      ...
      var eventParams = _extend({}, eventArgs, { evid: EVENT_IDS.ROUTE_CHANGE, view: viewName });
    ...
    function _sendBiEvent(eventArgs, callback) {
      ...
      if (policy && (policy.functional === false || policy.analytics === false)) {
        return;
      }

      var biUrl = args.hostName || args.biUrl ? _options.biUrl : globalApi.getBiUrl(globalApi.getCommonConfigValue('brand'));
