...
exports.SVG_TYPES = exports.getAll = exports.elementsRegexes = exports.attributesRegexes = exports.parseSvgString = void 0;
const SVG_TYPES = {
    SHAPE: 'shape',
    TINT: 'tint',
    COLOR: 'color',
...
exports.attributesRegexes = attributesRegexes;
const elementsRegexes = {
    svg: /(<svg(.*?)>)/g,
    path: /(<path(.*?)>)/g,
};
exports.elementsRegexes = elementsRegexes;
