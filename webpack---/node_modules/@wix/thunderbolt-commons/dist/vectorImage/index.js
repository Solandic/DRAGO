...
function transformToTintColors(svgString, resolvedColor) {
    ...
    return svgString.replace(fillAttributeMatcher, (__, colorToTint) => {
        ...
        if ((0, color_1.isGreyscale)(colorObj)) {
            ...
            const tintedColor = (0, color_2.default)({ r: rTint, g: gTint, b: bTint });
            // return tinted color
...
exports.transformToTintColors = transformToTintColors;
...
function addA11yAttributes(svgString, altText) {
...
function getShadowFilter(filterId, shadow, layout, hexColor, mergeGraphic) {
    const filterString = (0, svgFilters_1.getShadow)(filterId, { ...shadow, color: hexColor, mergeGraphic });
...
function wrapWithShadow({ compId, svgString, layout, colorsMap, shadow, shadowOnly = false, }) {
...
const transformVectorImage = (rawSvg, { altText, compId, svgInfo, properties, layout, shadow, isResponsive, colorsMap, overrideColors: overrideColorsInuput, }) => {
...
exports.trimSvgContents = trimSvgContents;
const getShapeDividerImageCss = (rawSvg, { color, height, keepAspectRatio, compId, side, shouldRepeat, repeatCount, shouldInvert, svgInfo, }) => {
    ...
    const scaledSvg = getScaledSvgViewBox(rawSvg, { svgType: svgInfo.svgType, bbox: viewBoxOverride, viewBox: viewBoxOverride }, { aspectRatio });
