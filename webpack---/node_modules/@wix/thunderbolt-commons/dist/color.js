...
const generateGradient = (colorLayers, alpha, colorMap) => (0, css_gradient_generator_1.generate)(colorLayers, { alpha, resolveColor: (color) => getFromColorMap(color, colorMap) });
