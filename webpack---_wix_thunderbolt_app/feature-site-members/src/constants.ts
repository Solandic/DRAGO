...
export const APPS = {
	PLATFORMIZED_AUTH: '1052fa8e-e3e2-46dc-ab66-8badb2d08fe9',
}
...
export const ROUTER_PREFIX = 'auth'

export const TPA_PAGE_IDS_TO_ROUTES = {
	[TPA_PAGES.FORGOT_PASSWORD]: `${ROUTER_PREFIX}/forgot-password`,
	[TPA_PAGES.RESET_PASSWORD]: `${ROUTER_PREFIX}/reset-password`,
	[TPA_PAGES.ADMIN_APPROVAL]: `${ROUTER_PREFIX}/admin-approval`,
	[TPA_PAGES.EMAIL_CONFIRMATION]: `${ROUTER_PREFIX}/email-confirmation`,
	[TPA_PAGES.EXPIRED_TOKEN]: `${ROUTER_PREFIX}/expired-token`,
	[TPA_PAGES.ACCESS_RESTRICTED]: `${ROUTER_PREFIX}/access-restricted`,
}
...
export const ERROR_TRANSLATIONS: {
	...
	membersServerError_SESSION_BY_ID_NOT_FOUND_OR_NOT_ACTIVE: {
		...
		default: 'There was a technical error on our end. Refresh the page or try again later.',
	},
	membersServerError_RECOVERY_TOKEN_DATA_NOT_FOUND: {
		namespace: 'dialogMixinTranslations',
	...
	membersServerError_IP_ADDRESS_BLACKLISTED: {
		...
		default: 'Your IP address isn’t valid, if you’re using a VPN try changing your IP.',
	},
}
