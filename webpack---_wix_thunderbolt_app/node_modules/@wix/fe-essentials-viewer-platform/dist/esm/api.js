...
export class _AppEssentials {
    constructor({ env, essentials }) {
        ...
        const { platformEnv, appDefId, shouldElevateBlocksAppPermissions, artifactId } = env;
        const { isSSR, baseUrl, multilingualOptions, language, getAppToken, appsConductedExperiments, } = platformEnv;
        this.experiments = new ReadOnlyExperiments({
            experiments: appsConductedExperiments?.[appDefId] ?? {},
        });
        this.errorHandler =
            essentials.experiments.get('specs.os.EnableErrorHandlerInViewer') ===
                true ||
                ...
                ? new ErrorHandler({
                    ...
                    createI18n: (options) => initI18n({
                        ...options,
                        locale: multilingualOptions?.lang || language || 'en',
                    }),
                    biDefaultsOverrides: {
...
export class _ControllerEssentials {
    constructor({ env, appEssentials }) {
        ...
        this.errorHandler = this.appEssentials.errorHandler;
        this.createCurrencyFormatterWithDefaults =
