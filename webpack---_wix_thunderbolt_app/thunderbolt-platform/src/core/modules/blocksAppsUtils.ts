...
import { IBlocksAppsUtils, ViewerAppSpecData } from '@wix/thunderbolt-symbols'
...
export const BlocksAppsUtils = (bootstrapData: BootstrapData): IBlocksAppsUtils => {
	...
	return {
		...
		createBlocksConsumerAppData(appSpecData: ViewerAppSpecData) {
			return {
				blocksConsumerData: {
					...
					widgetBundleUrls: blocksBootstrapData.widgetBundleUrls?.[appSpecData.appDefinitionId],
				},
			}
		},
