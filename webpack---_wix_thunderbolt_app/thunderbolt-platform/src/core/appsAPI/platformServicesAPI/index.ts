...
import type { PlatformServicesAPI, PlatformEnvData, SessionServiceAPI, Experiments, IBlocksAppsUtils, AppUrlData } from '@wix/thunderbolt-symbols'
...
export const createPlatformAppServicesApi = ({
	...
	appUrlData: AppUrlData | undefined
	...
	const artifactId = appUrlData ? artifactIdRgx.exec(appUrlData.viewerScriptUrl)?.[1] : undefined
